...
trajectories and sealed labels, while \method estimates target risk from a
tight graph-spectral decomposition of candidate disagreement. The resulting
analysis identifies cross-model error covariance as the central hidden term
and quantifies how covariance transport error affects recovered risk. In the
...
not reliably predict risk-correction geometry for unseen shift families. This
