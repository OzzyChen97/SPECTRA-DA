...
The experiments ask three questions: whether the frozen selector improves
label-free model selection, whether graph frequencies expose distinct
covariance regimes, and which limitations remain after controlled refinement.
...
\begin{table*}[t]
  ...
  Table~\ref{tab:core_ablation}. Best values are bold.}
  ...
  \begin{tabular}{lrrrrr}
    ...
    \midrule
    Source validation & 0.2638 & 11.56 & \textbf{0.761} & 0\% & 53.40 \\
    Last source validation & 0.2388 & 10.93 & 0.683 & 0\% & 54.03 \\
    Entropy & 0.2153 & 8.80 & 0.526 & \textbf{50\%} & 56.17 \\
    Infomax & 0.1984 & 7.84 & 0.577 & \textbf{50\%} & 57.12 \\
    DEV & 0.5013 & 27.10 & 0.405 & 0\% & 37.86 \\
    SND & 0.8780 & 47.12 & $-0.582$ & 0\% & 17.84 \\
    Transfer Score & \textbf{0.1467} & \textbf{6.33} & 0.356 & \textbf{50\%} & \textbf{58.64} \\
    GDE & 0.7539 & 38.73 & 0.001 & 0\% & 26.24 \\
    ALine-S & 0.2638 & 11.56 & \textbf{0.761} & 0\% & 53.40 \\
    ...
    \method & 0.2560 & 12.16 & 0.695 & 0\% & 52.81 \\
    \bottomrule
  \end{tabular}%
  }
\end{table*}
...
top choice. This gap localizes the main empirical weakness to top-of-ranking
calibration rather than wholesale failure of the recovered ordering.
...
\begin{table*}[t]
  ...
  Lower regret and higher rank/hit metrics are better.}
  ...
  \begin{tabular}{lrrrr}
    ...
    \textbf{0.9442} & \textbf{95.5\%} \\
    Spectral + cov. + UCB, no robust refit & \textbf{0.01397} &
    \textbf{0.04758} & 0.9398 & \textbf{95.5\%} \\
    Spectral + cov., no UCB & 0.01452 & 0.04941 & 0.9434 &
    \textbf{95.5\%} \\
    \method{} (frozen full) & 0.01415 & 0.04793 & 0.9424 &
    \textbf{95.5\%} \\
    \bottomrule
  \end{tabular}%
  }
...
\begin{table}[t]
  ...
  \begin{tabular}{lrrrr}
    ...
    \midrule
    Mean $|$error correlation$|$ & 0.487 & \textbf{0.381} & 0.573 & 0.617 \\
    Transport NMAE & 0.092 & 0.227 & \textbf{0.069} & 0.186 \\
    Below global & -- & 98.9\% & 0.0\% & 5.1\% \\
    \bottomrule
  \end{tabular}
\end{table}
...
Blog, and Twitch families, paired task-level uncertainty, and equal-information
comparison to global calibration. We preserve this boundary throughout the
paper.
