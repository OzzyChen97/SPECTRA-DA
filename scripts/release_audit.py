...
REQUIRED_FILES = [
    ...
    "selector/shortlist_error_decomposition.py",
    "selector/crossfit_agreement.py",
    "selector/trajectory_shortlist_selection.py",
    "selector/trajectory_aware_rerank.py",
    "selector/coverage_floor_selection.py",
    "selector/auxiliary_shortlist_selection.py",
    "selector/bootstrap_stability_selection.py",
    "selector/bootstrap_transfer_score.py",
    "selector/stability_router_diagnostic.py",
    "selector/stage_c_promotion_audit.py",
    ...
    "results/gda_select/open_dev/stage_c_stability_router_diagnostic.json",
    "results/gda_select/open_dev/stage_c_promotion_audit.json",
]
...
PYTHON_SYNTAX_FILES = [
    ...
    "tests/selector/test_shortlist_error_decomposition.py",
    "tests/selector/test_crossfit_agreement.py",
    "tests/selector/test_trajectory_shortlist_selection.py",
    "tests/selector/test_trajectory_aware_rerank.py",
    "tests/selector/test_coverage_floor_selection.py",
    "tests/selector/test_auxiliary_shortlist_selection.py",
    "tests/selector/test_bootstrap_stability_selection.py",
    "tests/selector/test_bootstrap_transfer_score.py",
    "tests/selector/test_stability_router_diagnostic.py",
    "tests/selector/test_stage_c_promotion_audit.py",
